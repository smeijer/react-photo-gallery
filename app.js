...
var CustomImage = function CustomImage(_ref) {
  ...
  var height = _ref$photo.height;
  var width = _ref$photo.width;
  var src = _ref$photo.src;
  var onClick = _ref.onClick;
  return _react2["default"].createElement(
    "div",
    { className: "thumb", style: { height: height, width: width }, onClick: function () {
        return onClick({ index: index, photo: photo });
      } },
    _react2["default"].createElement("div", { className: "img", style: { backgroundImage: "url(" + src + ")" } }),
...
var noImg = window.location.search.indexOf('no-img=1') > -1;
var photos = Array.from(Array(25)).map(function (x, idx) {
  var width = randomBetween(400, 1200);
  var height = randomBetween(400, 1200);
  var src = unsplash + '/' + width + 'x' + height;
  ...
  return {
    ...
    title: 'Photo ' + idx,
    alt: 'Photo ' + idx,
    srcSet: noImg ? [] : [unsplash + '/' + Math.floor(width * 1.25) + 'x' + Math.floor(height * 1.25) + ' ' + Math.floor(width * 1.25) + 'w', unsplash + '/' + Math.floor(width * 1.5) + 'x' + Math.floor(height * 1.5) + ' ' + Math.floor(width * 1.5) + 'w', unsplash + '/' + Math.floor(width * 1.75) + 'x' + Math.floor(height * 1.75) + ' ' + Math.floor(width * 1.75) + 'w', unsplash + '/' + Math.floor(width * 2) + 'x' + Math.floor(height * 2) + ' ' + Math.floor(width * 2) + 'w'],
...
var App = (function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'openLightbox',
    value: function openLightbox(event, _ref) {
      var index = _ref.index;
    ...
    value: function getColumnCount() {
      var width = this.props.contentRect.bounds.width;
    ...
    value: function render() {
      ...
      var measureRef = _props.measureRef;
      var photos = _props.photos;
      var _state = this.state;
      var currentImage = _state.currentImage;
      var lightboxIsOpen = _state.lightboxIsOpen;

      return _react2['default'].createElement(
        'div',
        { className: 'App', ref: measureRef },
        _react2['default'].createElement(
          'div',
          { style: { margin: '0 auto', padding: '0 130px', minWidth: 400, maxWidth: '80%' } },
...
var EnhancedApp = (0, _reactMeasure.withContentRect)('bounds')(App);

_reactDom2['default'].render(_react2['default'].createElement(EnhancedApp, { photos: photos }), document.getElementById('app'));

},{"./CustomImage":1,"react":undefined,"react-dom":undefined,"react-images":undefined,"react-measure":14,"react-photo-gallery":undefined}],3:[function(require,module,exports){
"use strict";
...
},{"./lib/ReactPropTypesSecret":10,"fbjs/lib/invariant":4,"fbjs/lib/warning":5}],7:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./lib/ReactPropTypesSecret":10,"fbjs/lib/emptyFunction":3,"fbjs/lib/invariant":4}],8:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./checkPropTypes":6,"./lib/ReactPropTypesSecret":10,"fbjs/lib/emptyFunction":3,"fbjs/lib/invariant":4,"fbjs/lib/warning":5}],9:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
module.exports = exports['default'];
},{"./with-content-rect":15,"react":undefined}],12:[function(require,module,exports){
'use strict';
...
},{"./Measure":11,"./with-content-rect":15}],15:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./get-content-rect":12,"./get-types":13,"prop-types":9,"react":undefined,"resize-observer-polyfill":16}],16:[function(require,module,exports){
