...
},{"./with-content-rect":13,"react":undefined}],10:[function(require,module,exports){
'use strict';
...
},{"./Measure":9,"./with-content-rect":13}],13:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./get-content-rect":10,"./get-types":11,"prop-types":7,"react":undefined,"resize-observer-polyfill":14}],14:[function(require,module,exports){
...
var Gallery = (function (_PureComponent) {
  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      var height = last.posY + last.height;

      return _react2['default'].createElement(
        'div',
        { style: _extends({}, styles.gallery, { height: height }), ref: measureRef },
        thumbs.map(function (photo, index) {
          return _react2['default'].createElement(ImageComponent, { key: photo.key || photo.src, index: index, photo: photo, onClick: _this.handleClick });
        })
      );
    }
  }]);
...
},{"./Photo":16,"./utils":17,"prop-types":7,"react-measure":12}],16:[function(require,module,exports){
(function (global){
'use strict';
...
var imgStyleWithOnClick = _extends({}, imgStyle, { cursor: 'pointer' });
...
var Photo = (function (_PureComponent) {
  ...
  _createClass(Photo, [{
    ...
    value: function render() {
      ...
      var src = _props2$photo.src;
      var width = _props2$photo.width;
      var height = _props2$photo.height;
      var posX = _props2$photo.posX;
      var posY = _props2$photo.posY;
      var onClick = _props2.onClick;

      var style = typeof onClick === 'function' ? imgStyleWithOnClick : imgStyle;

      return _react2['default'].createElement('div', {
        style: _extends({}, style, { width: width, height: height, transform: 'translate(' + posX + 'px, ' + posY + 'px)', backgroundImage: 'url(' + src + ')' }),
...
},{"prop-types":7}],17:[function(require,module,exports){
"use strict";
...
function computeSizes(_ref2) {
  ...
  var rowsWithSizes = rows.map(function (row, rowIndex) {
    ...
    var newRow = row.map(function (photo, idx) {
      var width = idx !== row.length - 1 || row.length === 1 ? // eslint-disable-line
      Math.floor(height * ratio(photo)) : rowWidth - currentX; // fix last cell width to include rounding loss

      var cell = _extends({}, photo, {
        height: height,
        width: width,
        posX: currentX,
        posY: currentY
